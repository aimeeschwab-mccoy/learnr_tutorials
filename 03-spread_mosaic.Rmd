...
favstats(~age|hlthplan, data=brfss)
```
...
histogram(~__|__, data=brfss)
```

```{r, exercise3-solution}
histogram(~age|hlthplan, data=brfss)
```
...
histogram(~ratio|location, data=diabetes)
```
